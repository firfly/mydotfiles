...
return {
    ...
    init = function()
        local colorInline_bg = colors["firfly_color02"]
        local color_fg = colors["firfly_color26"]
        -- local color_sign = "#ebfafa"
        if vim.g.md_heading_bg == "transparent" then
            -- Define color variables
            local color1_bg = colors["firfly_color04"]
            local color2_bg = colors["firfly_color02"]
            local color3_bg = colors["firfly_color03"]
            local color4_bg = colors["firfly_color01"]
            local color5_bg = colors["firfly_color05"]
            local color6_bg = colors["firfly_color08"]
            local color_fg1 = colors["firfly_color18"]
            local color_fg2 = colors["firfly_color19"]
            local color_fg3 = colors["firfly_color20"]
            local color_fg4 = colors["firfly_color21"]
            local color_fg5 = colors["firfly_color22"]
            local color_fg6 = colors["firfly_color23"]
            ...
            local color1_bg = colors["firfly_color18"]
            local color2_bg = colors["firfly_color19"]
            local color3_bg = colors["firfly_color20"]
            local color4_bg = colors["firfly_color21"]
            local color5_bg = colors["firfly_color22"]
            local color6_bg = colors["firfly_color23"]
